...
class ChatbotPage extends StatefulWidget {
  ...
  const ChatbotPage({super.key, required this.config});
...
class _ChatbotPageState extends State<ChatbotPage> {
  ...
  Future<void> sendMessage(String message) async {
    final String? apiKey = widget.config['API_KEY'];
    print("Clave API cargada: $apiKey");
    ...
    try {
      ...
      setState(() {
        _messages.add(
            {"sender": "bot", "message": "Error: No hay conexión a Internet."});
      });
    }
  }
